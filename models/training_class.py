...
class TrainingClass:
    def __init__(self, id=None, name=None, discipline=None, teacher_id=None, schedule=None, capacity=None, description=None, created_at=None, updated_at=None, default_monthly_fee=0.0, **kwargs):
    ...
    def from_dict(source):
        ...
        class_obj = TrainingClass(
            ...
            default_monthly_fee=source.get('default_monthly_fee', 0.0)
        )
        return class_obj
